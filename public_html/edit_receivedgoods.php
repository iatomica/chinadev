        ...
        <div class="col-md-12">
          <form id="addreceivedgoods" method="post" class="clearfix" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="vendor-rg" id="vendor-rg" disabled>
                    ...
                    <?php foreach ($all_vendors as $ven): ?>
                      <option value="<?php echo (int)$ven['id']; ?>" <?php if ($rgid['vendors_id'] === $ven['id']): echo "selected";
                                                                    endif; ?>>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="client-rg" name="client-rg" disabled>
                    ...
                    <?php foreach ($all_clients as $cli): ?>
                      <option value="<?php echo (int)$cli['id']; ?>" <?php if ($rgid['clients_id'] === $cli['id']): echo "selected";
                                                                    endif; ?>>
            ...
            <div class="table-responsive">
              ...
              <div><button type="button" name="additem-rg" id="additem-rg" class="btn btn-success btn-xs" <?php if ($rgid['finalized'] === '1'): echo "disabled";
                                                                                                          endif; ?>>Add item</button></div>
              <div class="pull-right">
                <button type="submit" name="insert_receivedgoods" class="btn btn-primary" <?php if ($rgid['finalized'] === '1'): echo "disabled";
                                                                                          endif; ?>>Submit</button>
              </div>
              <div class="pull-right">
                <a href="receivedgoods.php" class="btn btn-primary" style="padding: 7px"><?php if ($rgid['finalized'] === '1'): echo "Back";
                                                                                          else: echo "Stay Pending";
                                                                                          endif; ?></a>
              </div>
            </div>
        </div>
