      ...
      <div class="panel-body">
        <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="client-po" id="client-po" disabled>
                    ...
                    <?php foreach ($all_clients as $cli): ?>
                      <option value="<?php echo (int)$cli['id']; ?>" <?php if ($poid['clients_id'] === $cli['id']): echo "selected";
                                                                    endif; ?>>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="client-po" id="client-po" disabled>
                    ...
                    <?php foreach ($all_vendors as $ven): ?>
                      <option value="<?php echo (int)$ven['id']; ?>" <?php if ($poid['vendors_id'] === $ven['id']): echo "selected";
                                                                    endif; ?>>
            ...
            <div class="row">
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  <select class="form-control" name="money-po" <?php if ($poid['finalized'] === '1'): echo "disabled";
                                                                endif; ?> disabled>
                    <option value="">Select Currency</option>
                    <?php foreach ($all_moneys as $money): ?>
                      <option value="<?php echo (int)$money['id']; ?>" <?php if ($poid['moneys_id'] === $money['id']): echo "selected";
                                                                      endif; ?>>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" name="tp-po" step="any" placeholder="Insert TP" value="<?php echo remove_junk($poid['tp']); ?>" autocomplete="off" <?php if ($poid['finalized'] === '1'): echo "disabled";
                                                                                                                                                                                  endif; ?> disabled>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" name="tpsup-po" step="any" placeholder="Insert TP Supervisor" value="<?php echo remove_junk($poid['tpname']); ?>" autocomplete="off" <?php if ($poid['finalized'] === '1'): echo "disabled";
                                                                                                                                                                                                  endif; ?> disabled>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="observation-po" step="any" placeholder="Insert Observation" value="<?php echo remove_junk($poid['observation']); ?>" autocomplete="off" <?php if ($poid['finalized'] === '1'): echo "disabled";
                                                                                                                                                                                                        endif; ?> disabled>
                </div>
              </div>
            </div>
          ...
          <div class="table-responsive">
            ...
            <div><button type="button" name="additem-po" id="additem-po" class="btn btn-success btn-xs" <?php if ($poid['finalized'] === '1'): echo "disabled";
                                                                                                        endif; ?>>Add item</button></div>
